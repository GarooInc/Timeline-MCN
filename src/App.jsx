...
const FichaComponent = ({ficha, links}) => (
  <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex justify-center items-center">
      <button onClick={() => setShowFicha(false)} className="absolute top-4 right-2 md:top-10 md:right-10 m-4 text-black text-3xl">&times;</button>
      <div className="bg-white rounded-md custom-shadow w-full h-full flex flex-col justify-start md:justify-center items-center">
          {
            ficha && (
              <div className="flex flex-col justify-center items-center p-4 gap-2 md:p-8 md:m-0 mt-12">
